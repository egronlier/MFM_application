        ...
        boutonValider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (length_name > 0 && length_surname > 0) {
                    ...
                    if (Pattern.matches("[a-zA-ZáàâäãåçéèêëíìîïñóòôöõúùûüıÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜİŸÆŒ-]*", name)) {
                        if (Pattern.matches("[a-zA-ZáàâäãåçéèêëíìîïñóòôöõúùûüıÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜİŸÆŒ-]*", surname)) {
